...
if %ERRORLEVEL% neq 0 (
    ...
    echo   BUILD FAILED
    echo ===================================================
    echo Check the error messages above. You may need to install Android SDK or Java JDK.
    pause
    exit /b %ERRORLEVEL%
)
...
cd ..\..
copy "PartsMobile\android\app\build\outputs\apk\release\app-release.apk" "PartsMobile_Release.apk"
